...
class Title(Scene):
    ...
    def draw(self):
        ...
        pyxel.text(6, 2, "TOP {0:5}".format(self.__data.get_score()), pyxel.COLOR_DARK_BLUE)
        ...
        if (self.__blink & 0x20) == 0:
            ...
            x = 12
            y = 57
            pyxel.text(x - 1, y + 0, s, pyxel.COLOR_DARK_BLUE)
            pyxel.text(x + 1, y + 0, s, pyxel.COLOR_DARK_BLUE)
            pyxel.text(x + 0, y - 1, s, pyxel.COLOR_DARK_BLUE)
            pyxel.text(x + 0, y + 1, s, pyxel.COLOR_DARK_BLUE)
